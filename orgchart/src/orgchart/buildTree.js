...
function finalizeTree(nodesToRender, allNodes, lineaFiltro, corporativoExpandido, mode = "Persona") {
  ...
  // conserva su orden original y no entra en este re-orden). Aplica igual en
  // Persona y Cargo — cada modo usa el orden de llegada de su propio
  // allNodes (empleados en Persona, posiciones en Cargo), a pedido
  // explícito para que ambas vistas muestren el mismo orden en RETAIL.
